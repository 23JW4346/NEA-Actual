    ...
    public class Complex
    {
        ...
        public Complex(string strcomp)
        {
            ...
            foreach (char c in strcomp)
            {
                ...
                {
                    if (temp == "") imaginary = new Number(1);
                    else if (temp == "-") imaginary = new Number(-1);
        ...
        public string GetComplex()
        {
            string outputreal = "";
            string outputimag = "";
            if (real.GetString(false) == "0" && imaginary.GetString(true) == "0") return "0";
            if (real.GetString(false) != "0") outputreal += real.GetString(false);
            if (imaginary.GetString(false) != "0")
            {
                outputimag += "";
                if (imaginary.GetValue() == 1) outputimag += "i";
                else if (imaginary.GetValue() == -1) outputimag += "-i";
                else outputimag += imaginary.GetString(true);
            }
        ...
        public Number GetModulus()
        {
            ...
            {
                if (pythag % (int)Math.Pow(i, 2) == 0) coef = i;
        ...
        //returns a*b
        public static Complex operator *(Complex a, Complex b) => new Complex(a.GetRealValue() * b.GetRealValue() - a.GetImaginaryValue() * b.GetImaginaryValue(), a.GetImaginaryValue() * b.GetRealValue() + a.GetRealValue() * b.GetImaginaryValue());

        //multiplies complex by scalar
        public static Complex operator *(double a, Complex b) => new Complex(a * b.GetRealValue(), a * b.GetImaginaryValue());
        ...
        public static bool operator ==(Complex a, Complex b) => a.GetRealValue() == b.GetRealValue() && a.GetImaginaryValue() == b.GetImaginaryValue();
